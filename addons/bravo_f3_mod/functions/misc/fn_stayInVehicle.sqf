...
if (missionNamespace getVariable["bravo_f3_mod_param_debugMode",0] == 1) then {diag_log text format["[F3] DEBUG (fn_stayInVehicle.sqf): Found: %1 vehicles",count _vehicles];};
