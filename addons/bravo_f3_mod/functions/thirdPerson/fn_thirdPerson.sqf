...
// Default to off
if (missionNamespace getVariable["bravo_f3_mod_param_thirdPerson",0] == 0) exitWith {};

player switchCamera "INTERNAL";

// 3rd in Vehicles Only
if (bravo_f3_mod_param_thirdPerson == 1) exitWith { 
...
if (bravo_f3_mod_param_thirdPerson == 2) exitWith {
