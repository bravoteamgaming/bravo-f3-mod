...
if (isNull _curator) exitWith {
	...
	_curator = [format["bravo_f3_mod_Zeus%1", name _unit],  getPlayerUID _unit] call bravo_f3_mod_fnc_zeusCreate;
};
...
["fn_zeusAssign.sqf",format["Curator assigned to %1",name _unit],"INFO"] call bravo_f3_modf_fnc_logIssue;