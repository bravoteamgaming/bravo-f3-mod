...
private _srRadio = getText (configFile >> "CfgWeapons" >> bravo_f3_mod_radios_settings_acre2_standardSRRadio >> "displayName");

private _fRadiosLongRange = missionNamespace getVariable ["bravo_f3_mod_radios_settings_longRangeUnits",["leaders"]];
private _lrRadio = getText (configFile >> "CfgWeapons" >> bravo_f3_mod_radios_settings_acre2_standardLRRadio >> "displayName");

private _fRadiosExtraRadio = missionNamespace getVariable ["bravo_f3_mod_radios_settings_acre2_extraRadios",[]];
private _exRadio = getText (configFile >> "CfgWeapons" >> bravo_f3_mod_radios_settings_acre2_extraRadio >> "displayName");
...
} forEach bravo_f3_mod_var_acreLanguages;
...

{
	try {
		...
		private _frequency = [bravo_f3_mod_radios_settings_acre2_standardSRRadio, _preset, _chanNum, "frequencyTX"] call acre_api_fnc_getPresetChannelField;
...

{
	try {
		private _chanNum = _forEachIndex + 1;
		private _frequency = [bravo_f3_mod_radios_settings_acre2_standardLRRadio, _preset, _chanNum, "frequencyTX"] call acre_api_fnc_getPresetChannelField;
