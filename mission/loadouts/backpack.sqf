// BACKPACK: MEDIC
case "m": {
	[_bagmedium,_unit] call bravo_f3_mod_fnc_addBackpack;
...
case "rpg": {
	["rhs_rpg",_unit] call bravo_f3_mod_fnc_addBackpack;
...
case "dm": {
	[_bagsmall,_unit] call bravo_f3_mod_fnc_addBackpack;
...
case "hmgg": {
	[_baghmgg,_unit] call bravo_f3_mod_fnc_addBackpack;
};

// BACKPACK: HEAVY MG ASSISTANT GUNNER (HMGAG)
case "hmgag": {
	[_baghmgag,_unit] call bravo_f3_mod_fnc_addBackpack;
};
...
case "hatg": {
	[_baglarge,_unit] call bravo_f3_mod_fnc_addBackpack;
...
case "mtrg": {
	[_bagmtrg,_unit] call bravo_f3_mod_fnc_addBackpack;
};

// BACKPACK: MORTAR ASSISTANT GUNNER (MTRAG)
case "mtrag": {
	[_bagmtrag,_unit] call bravo_f3_mod_fnc_addBackpack;
};
...
case "hsamg": {
	[_baghsamg,_unit] call bravo_f3_mod_fnc_addBackpack;
};

// BACKPACK: HEAVY SAM ASSISTANT GUNNER (HSAMAG)
case "hsamag": {
	[_baghsamag,_unit] call bravo_f3_mod_fnc_addBackpack;
};
...
// BACKPACK: DIVER (DIV)
case "div": {
	[_bagmediumdiver,_unit] call bravo_f3_mod_fnc_addBackpack;
...
// BACKPACK: UAV
case "uav": {
	[_baguav,_unit] call bravo_f3_mod_fnc_addBackpack;
};
