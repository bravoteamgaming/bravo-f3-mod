...
case "v_car":
{
	...
	_unit addItemCargoGlobal [([_binos1,true] call bravo_f3_mod_fnc_arrayCheck),1];
	_unit addWeaponCargoGlobal [([_carbine,true] call bravo_f3_mod_fnc_arrayCheck), 1];
	...
	if (isNil "_RATmag") then {_unit addWeaponCargoGlobal [([_rat,true] call bravo_f3_mod_fnc_arrayCheck),1]} else {_unit addMagazineCargoGlobal [_RATmag,1]}; // RHS Single shot RPGs
...
case "v_tr":
{
	...
	_unit addItemCargoGlobal ["ToolKit",1];
	_unit addItemCargoGlobal [([_binos1,true] call bravo_f3_mod_fnc_arrayCheck),1];
	_unit addWeaponCargoGlobal [([_carbine,true] call bravo_f3_mod_fnc_arrayCheck), 2];	
	...
	if (isNil "_RATmag") then {_unit addWeaponCargoGlobal [([_rat,true] call bravo_f3_mod_fnc_arrayCheck),4]} else {_unit addMagazineCargoGlobal [_RATmag,4]}; // RHS Single shot RPGs
...
case "v_ifv":
{
	...
	clearBackpackCargoGlobal _unit;
	_unit addItemCargoGlobal ["ToolKit",1];
	_unit addItemCargoGlobal [([_binos1,true] call bravo_f3_mod_fnc_arrayCheck),2];
	_unit addWeaponCargoGlobal [([_carbine,true] call bravo_f3_mod_fnc_arrayCheck), 2];
	_unit addMagazineCargoGlobal [_riflemag, 8];
	...
	_unit addMagazineCargoGlobal [_satchel, 4];
	if (isNil "_RATmag") then {_unit addWeaponCargoGlobal [([_rat,true] call bravo_f3_mod_fnc_arrayCheck),2]} else {_unit addMagazineCargoGlobal [_RATmag,2]}; // RHS Single shot RPGs
...
case "crate_small":
{
	...
	_unit addMagazineCargoGlobal [_glsmoke, 4];
	_unit addMagazineCargoGlobal [_satchel, 2];
	if (isNil "_RATmag") then {_unit addWeaponCargoGlobal [([_rat,true] call bravo_f3_mod_fnc_arrayCheck),1]} else {_unit addMagazineCargoGlobal [_RATmag,2]}; // RHS Single shot RPGs
	_unit addMagazineCargoGlobal [_grenade, 8];
	_unit addMagazineCargoGlobal [_smokegrenade, 8];
	_unit addMagazineCargoGlobal [_smokegrenadealt, 2];
...
case "crate_med":
{
	...
	clearBackpackCargoGlobal _unit;
	_unit addItemCargoGlobal ["ToolKit",1];
	_unit addItemCargoGlobal [([_binos1,true] call bravo_f3_mod_fnc_arrayCheck),4];
	...
	_unit addMagazineCargoGlobal [_satchel, 4];
	if (isNil "_RATmag") then {_unit addWeaponCargoGlobal [([_rat,true] call bravo_f3_mod_fnc_arrayCheck),4]} else {_unit addMagazineCargoGlobal [_RATmag,6]}; // RHS Single shot RPGs
	_unit addMagazineCargoGlobal [_grenade, 12];
...
case "crate_large":
{
	...
	clearBackpackCargoGlobal _unit;
	_unit addItemCargoGlobal ["ToolKit",1];
	_unit addItemCargoGlobal [([_binos1,true] call bravo_f3_mod_fnc_arrayCheck),8];
	_unit addMagazineCargoGlobal [_riflemag, 8];
	...
	if (isNil "_RATmag") then {_unit addWeaponCargoGlobal [([_rat,true] call bravo_f3_mod_fnc_arrayCheck),6]} else {_unit addMagazineCargoGlobal [_RATmag,8]}; // RHS Single shot RPGs
